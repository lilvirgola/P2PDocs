...
def reliable_transport(), do: Application.get_env(:p2p_docs, :reliable_transport, P2PDocs.Network.ReliableTransport)[:module]
def crdt_manager(), do: Application.get_env(:p2p_docs, :crdt_manager, P2PDocs.CRDT.Manager)[:module]
end
